...
Die BundID ist nicht mit dem Online-Ausweis oder der künftigen EUDI-Wallet gleichzusetzen. Online-Ausweis und Wallet stellen starke Mittel zur elektronischen Identifizierung beziehungsweise zur Vorlage digitaler Nachweise bereit. Die BundID kann diese Mittel auf der Eingangsseite verwenden und gegenüber angebundenen Diensten eine einheitliche, datensparsame Anmeldung anbieten. So müssen Signaturanwendungen nicht jedes Identifizierungsmittel einzeln integrieren, und neue europäische Nachweise können später ergänzt werden, ohne die gesamte Vertrauensinfrastruktur umzubauen.
...
Der Weg zur Entscheidung ist auf zwölf Monate begrenzt. In den ersten sechs Monaten werden der offene BundID-Zugang, kurzlebige Zertifikate, ein portabler Nachweis, ein öffentliches Testlog, mindestens zwei unabhängig implementierte Prüfprogramme und die Kompatibilität mit einem unveränderten etablierten Open-Source-Client nachgewiesen. In den folgenden sechs Monaten kommen staatlich kontrollierte Testwurzeln, alle drei Identitätsprofile, unabhängige und offene Witnesses, eine Bedienoberfläche, offene Programmierschnittstellen, externe Sicherheitsprüfung sowie belastbare Betriebs- und Vollkostenmessung hinzu. Am Ende von Monat zwölf folgt eine öffentliche Produktionsentscheidung anhand vorher veröffentlichter Kriterien. Ein Erfolg wird nicht an der Zahl der Folien, sondern an Interoperabilität, Datenschutz, Sicherheitsbefunden, Verfügbarkeit, Betriebskosten, Nutzererfahrung und tatsächlicher Nutzung gemessen.
